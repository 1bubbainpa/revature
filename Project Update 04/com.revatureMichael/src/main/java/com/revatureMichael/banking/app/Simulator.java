...
import com.revatureMichael.banking.dao.CustomerDAO;
import com.revatureMichael.banking.dao.CustomerDAOImpl;
...
public class Simulator {
	...
	public static void main(String[] args) 
	{
		...
		Customer c = cusdao.selectCustomerByCredentials("Michael", "Ord");
		System.out.println("Customer Cred: " + c);
